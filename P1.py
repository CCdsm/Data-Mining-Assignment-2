# Problem 1 - Decision Trees with Iris Dataset
import numpy as np
import pandas as pd
...
# Create decision trees with different max_depth values
...
# Find the depth with highest recall, lowest precision, and best F1 score
